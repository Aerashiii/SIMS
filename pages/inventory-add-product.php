...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'cashier') {
    ...
    $page ='inventory-add-product'; //ASSIGNS THE NAME OF THE PAGE. THIS PAGE IS NAMED 'INVENTORY' AND IS USED IN THE HEADER.PHP FILE.
...
<main class="main-content-container">
    ...
    <div class="add-product-form-container">
        <div class="add-product-inventory-button-container">
            <a href="inventory.php" id="add-product-inventory-button">Inventory</a>
        </div>
