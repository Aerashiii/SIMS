    ...
    <div class="add-order-form-container">
        <form action="" id="add-order-product-form">
            ...
            <div class="order-form-group-container">
                <label>Product Name:</label>
                <input type="text" id="add-order-product-name"required>
            </div>
            <div class="order-form-group-container">
                <label>Brand:</label>
                <select name="" id="add-order-product-brand" required>
                    <option value="">- Select Brand -</option>
                </select>
            </div>
            <div class="order-form-group-container">
                <label>Category:</label>
                <select name="" id="add-order-product-category" required>
                    <option value="">- Select category -</option>
                </select>
            </div>
            <div class="order-form-group-container">
                <label>Subcategory:</label>
                <select name="" id="add-order-product-subcategory" required>
                    <option value="">- Select subcategory -</option>
                </select>
            </div>
            <div class="order-form-group-container">
                ...
                <div class="inventory-order-add-product-barcode-container">
                    <input type="text" id="add-order-product-barcode" maxlength="13" required>
                    <button id="inventory-add-order-product-generate-barcode-button">Generate</button>
                </div>
                
            </div>
            <div class="order-form-group-container">
                <label>Quantity:</label>
                <input type="text" id="add-order-product-quantity" required>
            </div>
            <div class="order-form-group-container">
                <label>Reorder Point:</label>
                <input type="text" id="add-order-product-reorder-point" required>
            </div>
            <div class="order-form-group-container">
                <label>Original Price:</label>
                <input type="text"id="add-order-product-original-price" required>
            </div>
            <div class="order-form-group-container">
                <label>Selling Price:</label>
                <input type="text" id="add-order-product-selling-price"  required>
            </div>
            <div class="order-form-group-container">
                <label>Supplier:</label>
                <select name="" id="add-order-product-select-supplier">
                    <option value="">- Select Supplier -</option>
                </select>
            </div>
            <div class="order-form-group-container">
                <label>Status:</label>
                <select name="" id="add-order-product-status" required>
                    <option value="pending">Pending</option>
                    <option value="completed">Completed</option>
                </select>
            </div>

            <input type="submit" id="add-order-product-submit-button">
        </form>
